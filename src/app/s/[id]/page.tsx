  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <nav className="text-sm text-muted-foreground mb-6">
        ...
        {party && (
          <>
            <Link href={`/p/${party.id}`} className="hover:text-foreground">
              {party.name}
            </Link>
            <span className="mx-2">/</span>
          </>
          ...
          <TabsContent value="party">
            <Card className="rounded-xs">
              ...
              <CardContent>
                <Link
                  href={`/p/${party.id}`}
                  className="block hover:bg-muted p-4 rounded-xs transition-colors"
                >
                  <div className="flex items-start gap-4">
                    {party.image?.[0] ? (
                      <img
                        ...
                        alt={party.name}
                        className="w-20 h-20 object-cover rounded-xs"
                      />
                    ) : (
                      <div className="w-20 h-20 bg-muted flex items-center justify-center rounded-xs">
                ...
                {party.owner && (
                  <div className="mt-6 pt-4 border-t">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 hover:bg-muted p-2 rounded-xs transition-colors"
                    >
